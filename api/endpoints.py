...
async def analyze(files: list[UploadFile] = File(...)):
    ...
    # Get the directory of the first uploaded file and create a 'graphs' subfolder

    base_dir = os.path.dirname(file_names[0]) or "graphs"
    graphs_dir = os.path.join(base_dir, "graphs")
    print(f"{base_dir}  @@@@@@@@@@@ {graphs_dir}")

    os.makedirs(graphs_dir, exist_ok=True)

    # Pass graphs_dir to GraphGenerator
